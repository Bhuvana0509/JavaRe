...
<f:view>
	...
	%>
 	<c:set var="link" value="AddSolution" scope="session"></c:set>
	</c:if>	
	<div >
	...
	<table border="0" width="100%" height="355">
		<tr>
			...
			<td valign="top" align="center"><br><h1 class="contentHEADER">Add Solution</h1> 
				<br><h:form id="AddLocationForm">
			...
			<h:panelGroup><h:outputText value="Enter Solution"></h:outputText><span class="fieldMANDATORY">*</span></h:panelGroup>
			<h:inputText id="solution" required="true" requiredMessage="Please Enter The Solution"  value="#{adminTasksMB.solutionName}"  style="width: 180px" styleClass="contentTEXT"></h:inputText>
			<h:message  for="solution"></h:message>
			</h:panelGrid>	<br>	
			<h:commandButton value="   Add   " styleClass="tableBUTTON" action="#{adminTasksMB.addSolution}"/><br><br>
