...
<title>Add Initiating Group Page</title>
...
<f:view>
	...
	<c:if test="${link!='AddInitiatingGroup'}">
	<%
	...
	%>
 	<c:set var="link" value="AddInitiatingGroup" scope="session"></c:set>
	</c:if>	
	<div >
	...
	<table border="0" width="100%" height="355">
		<tr>
			...
			<table width="100" height="100" border="0" class="navigator_left"
				...
				<tr>
					<td class="spaceBetweenLinks">
					 &gt; <h:outputLink value="AdminTasksHomePage.jsp" styleClass="anchor">Home </h:outputLink> 
					</td>
				</tr>
				<tr>
					<td class="spaceBetweenLinks" >			
					&gt; <h:outputLink value="AddLocation.jsp"
						styleClass="anchor">Add Location </h:outputLink>
					</td>
				</tr>
				<tr>
					<td  class="spaceBetweenVisitedLinks">
					&gt; <h:outputLink value="AddInitiatingGroup.jsp"
						styleClass="anchor">Add Initiating Group </h:outputLink>
					</td>
				</tr>
				<tr>
					<td  class="spaceBetweenLinks">
					&gt; <h:outputLink value="AddSource.jsp" styleClass="anchor">Add Source </h:outputLink>
					</td>
				</tr>
				<tr>
					<td  class="spaceBetweenLinks">
					&gt; <h:outputLink value="AddSolution.jsp" styleClass="anchor">Add Solution </h:outputLink>
					</td>
				</tr>
				 <tr>
				...
				<tr>
					<td  class="spaceBetweenLinks">
					&gt; <h:outputLink value="MaintainVerticalsAndModules.jsp" styleClass="anchor">Maintain Vertical And Modules</h:outputLink>
					</td>
				</tr>
				<!-- <tr>
					<td  class="spaceBetweenLinks">
					&gt; <h:outputLink	value="AddVertical.jsp" styleClass="anchor">Add Vertical</h:outputLink>
					</td>
				</tr>
		
				<tr>
					<td  class="spaceBetweenLinks">
					&gt; <h:outputLink	value="AddNewModule.jsp" styleClass="anchor">Add Module </h:outputLink>
					</td>
				</tr>-->
				
				<tr>
					<td  class="spaceBetweenLinks"> 
					&gt; <h:outputLink value="AddNewMember.jsp" styleClass="anchor">Add New User </h:outputLink>
					</td>
				</tr>
				<tr>
					<td  class="spaceBetweenLinks">&gt; <h:outputLink
				...
				<tr>
					<td  class="spaceBetweenLinks">
					&gt; <h:outputLink value="ChangeOthersPassword.jsp" styleClass="anchor">Change Others Password</h:outputLink>
					</td>
				</tr>
			</table>
			...
			<td valign="top" align="center"><br>
				<h1 class="contentHEADER">Add Initiating Group</h1> 
				<br>
			...
			<h:panelGroup><h:outputText value="Enter Initiating Group"></h:outputText><span class="fieldMANDATORY">*</span></h:panelGroup>
			<h:inputText id="initiatinggroup" required="true" requiredMessage="Please Enter The Initiating Group"  value="#{adminTasksMB.initiatingGroupName}" style="width: 180px" styleClass="contentTEXT"></h:inputText>
			<h:message   for="initiatinggroup"></h:message>
			</h:panelGrid>	<br>	
			<h:commandButton value="   Add   " styleClass="tableBUTTON" action="#{adminTasksMB.addInitiatingGroup}"/><br><br>
