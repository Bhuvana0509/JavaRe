...
<f:view>
	...
	%>
 	<c:set var="link" value="AddVertical" scope="session"></c:set>
	</c:if>	
	<div >
	...
	<table border="0" width="100%" height="355">
		<tr>
			...
			<td valign="top" align="center"><br>
				<h1 class="contentHEADER">Add Vertical</h1> 
				<br>
			...
			<h:panelGroup><h:outputText value="Select Solution"></h:outputText><span class="fieldMANDATORY">*</span></h:panelGroup>
			<h:selectOneMenu  value="#{adminTasksMB.solutionId}" id="menu_solution" styleClass="listtableWHITESTRIP"  style="width: 185px">
			...
			<c:if test="${not empty adminTasksMB.solutionList}">
			<h:panelGroup><h:outputText value="Enter Vertical"></h:outputText><span class="fieldMANDATORY">*</span></h:panelGroup>
			<h:inputText id="vertical" required="true" requiredMessage="Please Enter The Vertical"  value="#{adminTasksMB.verticalName}" style="width: 180px" styleClass="contentTEXT"></h:inputText>
			<h:message   for="vertical"></h:message>
			
			<!--<h:panelGroup><h:outputText value="Enter Module Anchor"></h:outputText><span class="fieldMANDATORY">*</span></h:panelGroup>
			<h:inputText id="moduleanchor" required="true" requiredMessage="Please Enter The Module Anchor"  value="#{adminTasksMB.moduleAnchorName}" style="width: 180px" styleClass="contentTEXT"></h:inputText>
			<h:message  for="moduleanchor"></h:message>-->
			</c:if>
			</h:panelGrid>	<br>	
			
			<h:commandButton value="   Add   " styleClass="tableBUTTON"  action="#{adminTasksMB.addVertical}"/><br><br>
