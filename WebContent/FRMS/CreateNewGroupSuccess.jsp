...
<title>Create New Group Success page</title>
										...
										<table cellspacing="0" cellpadding="0" border="0" ID="Table2">
												<tr>
													...
													<table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;" ID="tblMy HomePage">
														<tr>
															<td nowrap="nowrap" align="Center" valign="Middle"><a id="hypl_1" class="mainnavTABSlinkOFF" href="DashboardHomePage.jsp.jsp">Dashboard</a></td>
														</tr>
													</table>
													</td>
...
<center>
<br>
<span class="contentHEADER">Group Details </span>
<br>
<h:form id="CreateNewGroupForm">
		
		<h:panelGrid border="0" columns="2" styleClass="filterBOX" style="width: 484px" columnClasses="pannelGridMainColumn,pannegGridColumLeftAllign">
			
			<h:outputText value="Group Id"></h:outputText>
			 <h:outputText value="#{createNewGroupMB.groupId}" style="width: 400px"></h:outputText>
		 
			 <h:outputText value="Group Name"></h:outputText>
			 <h:outputText value="#{createNewGroupMB.groupName}" style="width: 400px"></h:outputText>
		 
		     <h:outputText value="Req. Group Description"></h:outputText>
			 <h:outputText value="#{createNewGroupMB.groupDescription}" style="width: 400px"></h:outputText>
			         
			 <h:outputText value="Initating Group"></h:outputText>
			 <h:outputText value="#{createNewGroupMB.initiatingGroupName}" style="width: 400px"></h:outputText>
			
			 <h:outputText value="Source"></h:outputText>
			 <h:outputText value="#{createNewGroupMB.sourceName}" style="width: 400px"></h:outputText>
					
			 <h:outputText value="Market/Geography"></h:outputText>
			 <h:outputText value="#{createNewGroupMB.locationName}" style="width: 400px"></h:outputText>
								
			 <h:outputText value="Customer/Prospect"></h:outputText>
			 <h:outputText value="#{createNewGroupMB.customer_prospect}" style="width: 400px"></h:outputText>
								
			 <h:outputText value="Req. Group SPOC"></h:outputText>
			 <h:outputText value="#{createNewGroupMB.SPOC}" style="width: 400px"></h:outputText>
			 		
			 <h:outputText value="Comments"></h:outputText>
			 <h:outputText value="#{createNewGroupMB.comment}" style="width: 400px"></h:outputText>
		...
		<br><h:commandButton value="     Ok      " styleClass="tableBUTTON" action="ok"></h:commandButton>
		&nbsp;&nbsp;
		<br>
		<br><h:outputText styleClass="alertBOX" value="#{createNewGroupMB.successMessage}"/><br>
