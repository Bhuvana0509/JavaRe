...
<f:view>
	...
	%>
 	<c:set var="link" value="AddLocation" scope="session"></c:set>
	</c:if>	
	<div >
	...
	<table border="0" width="100%" height="355">
		<tr>
			...
			<table width="100" height="100" border="0" class="navigator_left"
				...
				<tr>
					<td class="spaceBetweenVisitedLinks" >&gt; <h:outputLink value="AddLocation.jsp"
			...
			<td valign="top" align="center"><br>
				<h1 class="contentHEADER">Add Location</h1> 
				<br>
			...
			<h:panelGroup><h:outputText value="Enter Location"></h:outputText><span class="fieldMANDATORY">*</span></h:panelGroup>
			<h:inputText id="location" required="true" requiredMessage="Please Enter The Location"  value="#{adminTasksMB.locationName}" style="width: 130px" styleClass="contentTEXT"></h:inputText>
			<h:message  for="location"></h:message>
			</h:panelGrid>	<br>	
			<h:commandButton value="   Add   " styleClass="tableBUTTON" action="#{adminTasksMB.addLocation}"/><br><br>
