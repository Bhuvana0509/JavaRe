...
<title>Maintain Vertical And Module Page</title>
...
<f:view>
	...
	<c:if test="${link!='MaintainVerticalAndModule'}">
	<%
	...
	%>
 	<c:set var="link" value="MaintainVerticalAndModule" scope="session"></c:set>
	</c:if>	
	<div >
	...
	<table border="0" width="100%" height="355">
		<tr>
			...
			<td valign="top" align="center"><br>
				<h1 class="contentHEADER">Maintain Vertical And Modules</h1> 
				<br>
			<h:form id="MaintainVerticalAndModulesForm">
			...
			<h:panelGroup><h:outputText value="Select Function"></h:outputText><span class="fieldMANDATORY">*</span></h:panelGroup>
			<h:selectOneMenu  value="#{adminTasksMB.selectFunction}" id="menu_function" styleClass="listtableWHITESTRIP"  style="width: 185px">
				<f:selectItem itemValue="0" itemLabel="-Select-"/>
				<f:selectItem itemValue="AddVertical" itemLabel="Add Vertical"/>
				<f:selectItem itemValue="AddNewModule" itemLabel="Add Module"/>
				<f:selectItem itemValue="ChangeVertical" itemLabel="Change Vertical"/>
				<f:selectItem itemValue="ChangeModule" itemLabel="Change Module"/>
				<f:validator validatorId="selectMenuValidatorId"/>
			</h:selectOneMenu>
			<h:message  for="menu_function"></h:message>
			
			</h:panelGrid>	<br>	
			
			<h:commandButton value="   View   " styleClass="tableBUTTON"  action="#{adminTasksMB.viewFunction}"/><br><br>
