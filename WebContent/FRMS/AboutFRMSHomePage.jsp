...
<title>About FRMS Home page</title>
...
<c:set var="link" value="AboutFRMSHomePage" scope="session"></c:set>
<div>
...
<td valign="top"> 
<br><center><h1 class="contentHEADER">About FRMS</h1></center>
<br><br><br><h1 class="bodyTEXT">
The Finacle Requirement Management System (FRMS) is an initiative to address the need to maintain requirements from end to end. The portal is aimed at providing traceability and complete coverage of requirements received in Finacle from clients,
market studies or any other internal initiatives.<br><br>
The idea behind the portal is to integrate all the teams that collate, collect or receive a lot of requirements from various quarters. Many a times, there is a duplication of tracking effort-sometimes the requirement even gets lost in all the tracking mechanisims.
The portal provides simplified central repository of all items, along with the functionality to group and maintain them according to the Finacle practices.  <br><br>
Key Features:-<br>

<ul>
    <li>  "One" System for Maintenance of Requirement from "Start" to "Completion" <br></li>
    <li>  Simplistic design, with minimal data filling effort. <br></li>
    <li>  Easy Maintenance and tracking. <br></li>
    <li>  Intuitive Navigation  <br></li>
    <li>  One Repository for all requirements received for Finacle</li>
