...
<title>Member Registration Success Page</title>
...
<f:view>
	...
	<table border="0" width="100%" height="355">
		<tr>
			...
			<table width="100" height="100" border="0" class="navigator_left"
				...
				<tr>
					<td  class="spaceBetweenVisitedLinks">&gt; <h:outputLink
						value="AddNewMember.jsp" styleClass="anchor"> Add New Member </h:outputLink>
					</td>
				</tr>
			</table>
			...
			<br>
				<span class="contentHEADER">Member Registration</span>
...
<h:outputText styleClass="alertBOXSuccess" value="#{employeeMB.message}"></h:outputText>
		<br><br>
		<br><br><h:form>
