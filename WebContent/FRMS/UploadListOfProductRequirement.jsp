...
<title>Upload List Of Product Requirement Page</title>
...
<c:if test="${link!='UploadListOfProductRequirement'}">
	<%
	...
	%>
 	<c:set var="link" value="UploadListOfProductRequirement" scope="session"></c:set>
	</c:if>	
									...
									<tr style="height: 94px">
										...
										<table cellspacing="0" cellpadding="0" border="0" ID="Table2">
												<tr>
													...
													<table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;" ID="tblMy Finance" class="mainnavTABSon">
														<tr>
...
<td align="center"> 
<br>
	<h1 class="contentHEADER">Upload Product Requirement Details</h1> 
	<br>
<h:form id="uploadMRForm" enctype="multipart/form-data"  >
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 	 ...
 	 <h:commandButton styleClass="tableBUTTON" value="Submit" type="submit" action="#{uploadListMB.uploadPRData}" />
 	 </span> <br><br><br><br>
	...
	<ul>
 	 	...
 	 	<li>Date should be in DD-MMM-YYYY format</li>  
 	 	<li>You can download Template Here -  
 	 	<h:commandLink action="#{uploadListMB.downloadPRTemplate}"><font face="Verdana"  size="2" color="##52A3CC">Download Template</font></h:commandLink>
 	 	  </li> 
