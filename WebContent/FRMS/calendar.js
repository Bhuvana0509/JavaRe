...
function showMyCalendar(posEl) {
	 
	var element=document.getElementById(posEl.name);
	var tgtElement=element.previousSibling;
	//alert(tgtElement.getAttribute("name"));
	
	showCalender(posEl, tgtElement.getAttribute("name"));
