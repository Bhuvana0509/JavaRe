...
<center>
 <h:form id="registerForm">
		...
		<h:panelGrid border="0" columns="3" styleClass="filterBOX" columnClasses="pannelGridMainColumn,pannegGridColumLeftAllign">
			<h:panelGroup>
			<h:outputText value="Enter Current Password"></h:outputText>
			<font color="red">
			<h:outputLabel value="*"></h:outputLabel></font>
			</h:panelGroup>
			<h:inputSecret id="txtcurr" value="#{employeeMB.password}" required="true" requiredMessage="Current password is mandatory" style="width: 130px" styleClass="contentTEXT">
		...
		<br>
		<h:commandButton id="submit" value="Submit" styleClass="tableBUTTON"  action="#{employeeMB.changePassword}" ></h:commandButton>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h:commandButton id="reset" value="Reset" styleClass="tableBUTTON"  type="reset" ></h:commandButton>
		<br>
		<br><br>
