...
<title>Change Module Anchor Page</title>
...
<f:view>
	 	<c:set var="link" value="ChangeModuleAnchorSuccess" scope="session"></c:set>
...
<h:panelGrid border="1" columns="2" styleClass="filterBOX" columnClasses="pannelGridMainColumn,pannegGridColumLeftAllign,pannegGridColumLeftAllign">
			...
			<h:outputText id="SolutionName" style="width: 130px" value="#{adminTasksMB.solutionId}" styleClass="contentTEXT"></h:outputText>	
			<h:outputText value="Vertical ID" />
			<h:outputText id="moduleId" style="width: 130px" value="#{adminTasksMB.verticalId}" styleClass="contentTEXT"></h:outputText>
						
			<h:outputText value="Vertical Name" />
			<h:outputText id="moduleName" style="width: 130px"  value="#{adminTasksMB.verticalName}" styleClass="contentTEXT">
			</h:outputText>
			
										
			<!--<h:outputText value="Module Anchor" />
			<h:outputText id="ModuleAnchor" style="width: 130px" value="#{adminTasksMB.moduleAnchorName}" styleClass="contentTEXT"></h:outputText>-->
								 				
		</h:panelGrid><br>
		<h:commandButton value="    OK    " action="moduleAnchorOk" styleClass="tableBUTTON" />
</h:form>
