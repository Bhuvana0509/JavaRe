...
<title>Master Requirements Home page</title>
...
<c:set var="link" value="MasterRequirementsHomePage" scope="session"></c:set>
<div>
												...
												<tr>
													...
													<table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;" ID="tblMy Finance">
														<tr>
															...
															<h:outputLink value="ProductRequirementsHomePage.jsp" styleClass="mainnavTABSlinkOFF" >Product Requirements </h:outputLink>
...
<td valign="top"> 
<br><center><h1 class="contentHEADER">Master Requirement </h1></center>
<br><br><br> space for information about the FRMS Master Requirement tab functionality</td>
</tr>
</table>
