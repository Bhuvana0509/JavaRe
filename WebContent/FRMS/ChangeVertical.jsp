...
<title>Change Vertical Page</title>
...
<f:view>
	...
	%>
 	<c:set var="link" value="ChangeVertical" scope="session"></c:set>
	</c:if>	
	<div >
	...
	<table border="0" width="100%" height="355">
		<tr>
			...
			<table width="100" height="100" border="0" class="navigator_left"
				...
				<tr>
					<td  class="spaceBetweenLinks">&gt; <h:outputLink
						value="MaintainVerticalsAndModules.jsp" styleClass="anchor">Maintain Verticals And Modules</h:outputLink>
					</td>
				</tr>
				<!-- <tr>
					<td  class="spaceBetweenLinks">&gt; <h:outputLink
			...
			<td valign="top" align="center"><br>
					<span class="contentHEADER">Change Vertical</span>
			...
			styleClass="listtableWHITESTRIP" valueChangeListener="#{adminTasksMB.getModuleListOfSelectedSolution}" onchange="submit()" style="width: 180px">
			...
			<h:selectOneMenu value="#{adminTasksMB.verticalId}" id="menu_module"
			styleClass="listtableWHITESTRIP" style="width: 180px">
				<f:selectItem itemValue="0" itemLabel="-Select-"/>
				<c:if test="${not empty adminTasksMB.verticalList}">
...
<br>
<br>
		<h:commandButton value="View" action="#{adminTasksMB.viewVerticalDetails}" styleClass="tableBUTTON"></h:commandButton>
		&nbsp;&nbsp;<br><br>

	</h:form>
	<c:if test="${adminTasksMB.verticalTO!=null}">
	<span class="contentHEADER">Vertical Details</span>
<h:form id="verticalDetailForm">
<h:panelGrid border="1" columns="3" styleClass="filterBOX" columnClasses="pannelGridMainColumn,pannegGridColumLeftAllign,pannegGridColumLeftAllign">
			...
			<h:outputText value="Vertical ID"/>
			<h:outputText id="verticalId" style="width: 130px" value="#{adminTasksMB.verticalId}" styleClass="contentTEXT">
			</h:outputText><h:outputText/>
			
			<h:panelGroup>
			<h:outputText value="Vertical Name"/><span class="fieldMANDATORY">*</span></h:panelGroup>
			<h:inputText id="verticalName" style="width: 180px" required="true" requiredMessage="Please Enter The Vertical Name" value="#{adminTasksMB.verticalName}" styleClass="contentTEXT">
			</h:inputText>
			<h:message for="verticalName"/>
		
			
		</h:panelGrid><br>
		<h:commandButton value="Save Changes" action="#{adminTasksMB.saveEditedVerticalDetails}" styleClass="tableBUTTON"/>
