...
<title>Add New Module Success Page</title>
	...
	<table border="0" width="100%" height="355">
		<tr>
			...
			<td align="center" valign="top">
					...
					<br>
					<span class="contentHEADER">Add New Module</span>
					...
					<h:form>
						<h:panelGrid styleClass="filterBOX" border="1" columns="2" columnClasses="pannelGridMainColumn,pannegGridColumLeftAllign">
							...
							<h:outputText
								value="#{adminTasksMB.moduleAnchorTO.moduleId}" style="width: 350px"></h:outputText>
							
							<h:outputText value="Module Name "></h:outputText>
							<h:outputText
								value="#{adminTasksMB.moduleName}" style="width: 350px"></h:outputText>
