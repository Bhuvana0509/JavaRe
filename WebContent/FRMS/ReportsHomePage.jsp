...
<c:set var="link" value="ReportsHomePage" scope="session"></c:set>
<div>
...
<td valign="top"> 
<br><center><h1 class="contentHEADER">Reports </h1></center>
<br><br><br>  space for information about the FRMS Reports functionality</td>
</tr>
</table>
