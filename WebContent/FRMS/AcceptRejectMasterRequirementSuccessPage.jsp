...
<title>Access/Reject Master Requirement Success page</title>
...
<br>
<span class="contentHEADER">Accpet or Reject Master Requirement</span>
<c:choose>
<c:when test="${viewAndUpdateMasterReqMB.acceptanceStatus=='Rejected' or viewAndUpdateMasterReqMB.acceptanceStatus=='Abandoned'}">
	<br><br><br><br><br>
	<h:outputText value="#{viewAndUpdateMasterReqMB.message}"></h:outputText>
</c:when>
<c:when test="${viewAndUpdateMasterReqMB.acceptanceStatus=='Accepted'}">
	 ...
	 <h:form>
		<h:commandButton value="      Ok      " styleClass="tableBUTTON" action="ok"></h:commandButton>
		</h:form>
