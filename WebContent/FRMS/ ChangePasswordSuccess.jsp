							...
							<table cellspacing="0" cellpadding="0" border="0"
								...
								<tr>
									<td nowrap="nowrap" align="Center" valign="Middle"><a
										id="hypl_1" class="mainnavTABSlinkON" href="Dashboard.jsp">Dashboard</a></td>
								</tr>
							</table>
							</td>
...
<table width="100" height="100" border="0" class= "navigator_left" style="width: 169px" > 
		<tr>
		 <td class="spaceBetweenLinks" >
		 	&gt; <h:outputLink value="DashboardHomePage.jsp"  styleClass="anchor" >Home</h:outputLink>
		  </td>
		</tr>
		<tr>
		 <td class="spaceBetweenLinks" >
		 	&gt; <h:outputLink value="MasterRequirementAddedByMe.jsp" styleClass="anchor" >Master requirements Added by me </h:outputLink>
		  </td>
		</tr>
		<tr>
		 <td class="spaceBetweenLinks" >
		 	&gt; <h:outputLink value="ProductRequirementsAssignedToMe.jsp"  styleClass="anchor" >Product scope items assigned to me</h:outputLink>
		  </td>
		</tr>
		<tr>
		 <td class="spaceBetweenVisitedLinks">
			&gt; <h:outputLink value="ChangePassword.jsp" styleClass="anchor">Change Password</h:outputLink>
		  </td>
		</tr>
...
<center>
 <h:form id="registerForm">
		<br>
		<h1 class="contentHEADER">Change Password</h1>
		
		<br>
		
				
				<h:commandButton value="    Ok    " action="ok" styleClass="tableBUTTON"></h:commandButton>
				<br><br><br> <h:outputText styleClass="alertBOX" value="#{employeeMB.message}"/>
			</h:form>
</center>
</td>
</tr>
