...
<title>Add ProductVersion Page</title>
...
<f:view>
	...
	<c:if test="${link!='AddProductVersion'}">
	<%
	...
	%>
 	<c:set var="link" value="AddProductVersion" scope="session"></c:set>
	</c:if>	
	<div >
	...
	<table border="0" width="100%" height="355">
		<tr>
			...
			<table width="100" height="100" border="0" class="navigator_left"
				...
				<tr>
					<td  class="spaceBetweenLinks">&gt; <h:outputLink
						value="MaintainVerticalsAndModules.jsp" styleClass="anchor">Add Localization</h:outputLink>
					</td>
				</tr>
				<tr>
					<td  class="spaceBetweenLinks">&gt; <h:outputLink
			...
			<td valign="top" align="center"><br><h1 class="contentHEADER">Add Product Version</h1> 
				<br><h:form id="AddProductVersionForm">
			...
			<h:panelGroup><h:outputText value="Enter Product Version"></h:outputText><span class="fieldMANDATORY">*</span></h:panelGroup>
			<h:inputText id="productVersion" required="true" requiredMessage="Please Enter The Product Version"  value="#{adminTasksMB.productVersion}"  style="width: 180px" styleClass="contentTEXT"></h:inputText>
			<h:message  for="productVersion"></h:message>
			</h:panelGrid>	<br>	
			<h:commandButton value="   Add   " styleClass="tableBUTTON" action="#{adminTasksMB.addProductVersion}"/><br><br>
